	...
	<div align="center">
		...
		<form action="login" method="post"
			...
			<label for="un">Username: </label> <input type="text" name="username"
				id="un" placeholder="Enter Your UserName"> <br> <br> 
				<label for="pwd">Password:</label> 
				<input type="password" name="password" id="pwd" placeholder="Enter Password"> <br> <br>
			<button>Login</button>
		</form>
		<br> <br> <a href="register"><button style="background-color:skyblue;height:30px;width:80px;border-radius:10px">Register</button></a>
	</div>
